...
\titulo{Proposta de conversor automático de Redes de Petri em códigos implementáveis para desenvolvimento de projetos de automa\c{c}\~ao} % titulo do trabalho em português
